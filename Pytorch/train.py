...
from Pytorch.model.generator_unetpp import Generator
from Pytorch.model.discriminator import Discriminator
from Pytorch.model.embedder_double_tanh import embed

from logger import Logger

from Pytorch.config import global_config
...
if __name__ == '__main__':
    # 初始化日志
    logger = Logger(CFG.TRAIN.EPOCHS, "./output/log")
    # 开始计时
